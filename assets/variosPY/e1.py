...
# esta es una constante normalmente se escriben con letras mayúsculas para diferenciarlas de las variables, aunque no es obligatorio
BONIFICACION = 20
...
# contatenamos las cadenas de texto de varias formas aquí tenéis una con la función format (f)
print(f"{cabecera.format(nombre1, nombre2)}")
...
print("al precio total le incrementamos su valor que tiene la constante:" +
